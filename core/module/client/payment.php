...
if ($paymentMethod->rowCount()) {
    ...
    if ($callbackSlug == "nayapay") {
        require("payment/nayapay.php");
        exit;
    }

    if ($callbackSlug == "upaisa") {
        require("payment/upaisa.php");
        exit;
    }

    if ($callbackSlug == "zindigi") {
        require("payment/zindigi.php");
        exit;
    }

    if ($callbackSlug == "sadapay") {
        require("payment/sadapay.php");
        exit;
    }

    if ($callbackSlug == "jazzcashbusiness") {
        require("payment/jazzcashbusiness.php");
        exit;
    }
    
    if ($callbackSlug == "payfast") {
        require("payment/payfast.php");
        exit;
    }
    
    if ($callbackSlug == "uddoktapay") {
        require("payment/uddoktapay.php");
        exit;
    }
    
    if ($callbackSlug == "nagorikpay") {
        require("payment/nagorikpay.php");
        exit;
    } 
    
    if ($callbackSlug == "piprapay") {
        require("payment/piprapay.php");
        exit;
    } 
