...
<input type="number" step="0.01" name="method_min" class="form-control" value="' . number_format($method["methodMin"], 2) . '"/></div>';
...
if ($method["methodId"] == 19 || $method["methodId"] == 19) {
    $form .= '<div class="form-group mb-3"><label class="form-label">Merchant ID</label>
    <input type="text"  name="merchantId" class="form-control" value="' . $methodExtras["merchantId"] . '"/></div>';
    $form .= '<div class="form-group mb-3"><label class="form-label">Secret Key</label>
    <input type="text"  name="merchantKey" class="form-control" value="' . $methodExtras["merchantKey"] . '"/></div>';
...
if ($method["methodId"] == 70) {
    ...
    $form .= '<div class="form-group mb-3"><label class="form-label">API URL</label>
    <input type="text"  name="api_url" class="form-control" value="' . $methodExtras["api_url"] . '"/></div>';
    $form .= '<div class="form-group mb-3"><label class="form-label">Currency Code</label>
    <input type="text"  name="currency" class="form-control" value="' . $methodExtras["currency"] . '"/></div>';
}
...
if ($method["methodId"] == 22) {
    $form .= '<div class="form-group mb-3"><label class="form-label">Merchant ID</label>
    <input type="text"  name="merchantId" class="form-control" value="' . $methodExtras["merchantId"] . '"/></div>';
    $form .= '<div class="form-group mb-3"><label class="form-label">Token</label>
    <input type="text"  name="token" class="form-control" value="' . $methodExtras["token"] . '"/></div>';
}
...
if ($method["methodId"] == 28) {
    $form .= '<div class="form-group mb-3"><label class="form-label">Api Key</label>
    <input type="text"  name="api_key" class="form-control" value="' . $methodExtras["api_key"] . '"/></div>';
    $form .= '<div class="form-group mb-3"><label class="form-label">Secret Key</label>
    <input type="text"  name="secret_key" class="form-control" value="' . $methodExtras["secret_key"] . '"/></div>';
      $form .= '<div class="form-group mb-3"><label class="form-label">Webhook Url</label>
    <input type="text"  name="web_hook_url" class="form-control" disabled value="' . site_url('binance_callback') . '"/></div>';
...
$form .= '<div class="custom-modal-footer"><button type="submit" data-loading-text="Updating..." class="btn btn-primary">Update</button>&nbsp;&nbsp;<button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancel</button></div></form>';
